...
public class RarLoadAction extends Action{
	public ActionForward execute(ActionMapping mapping,ActionForm form,
			...
			session.setAttribute("filter", ".rar");
			CopyOnWriteArrayList<String> rars=(CopyOnWriteArrayList<String>)singham.getAttribute(new ObjectName("org.singam.server:type=deployer,service=RARDeployer"), "RarsDeployed");
			StringBuffer buffer=new StringBuffer();
			buffer.append("<div id='tablediv'><table id='table' align='center'><thead><tr><th>"
					+ "delete</th><th>rars</th></tr></thead><tfoot>	<tr>		"
					+ "<th>delete</th>		<th>rars</th></tfoot><tbody>");
			for(String rar:rars){
				buffer.append("<tr><td align='center'><img src='delete.gif' class='mousechange' onclick='undeploy(\""+rar+"\")'/></td>");
