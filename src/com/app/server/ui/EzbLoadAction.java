...
public class EzbLoadAction extends Action{
	public ActionForward execute(ActionMapping mapping,ActionForm form,
			...
			CopyOnWriteArrayList<String> ezbs=(CopyOnWriteArrayList<String>)singham.getAttribute(new ObjectName("com.app.server:type=deployer,service=EZBeansDeployer"), "EzbDeployed");
