...
public class EzbLoadAction extends Action{
	public ActionForward execute(ActionMapping mapping,ActionForm form,
			...
			session.setAttribute("filter", ".ezb");
			CopyOnWriteArrayList<String> ezbs=(CopyOnWriteArrayList<String>)singham.getAttribute(new ObjectName("org.singam.server:type=deployer,service=EZBeansDeployer"), "EzbDeployed");
			StringBuffer buffer=new StringBuffer();
			buffer.append("<div id='tablediv'><table id='table' align='center'><thead><tr><th>"
					+ "delete</th><th>ezbs</th></tr></thead><tfoot>	<tr>		"
					+ "<th>delete</th>		<th>ezbs</th></tfoot><tbody>");
			for(String ezb:ezbs){
				buffer.append("<tr><td align='center'><img src='delete.gif' class='mousechange' onclick='undeploy(\""+ezb+"\")'/></td>");
				buffer.append("<td align='center'>"+ezb+"</td></tr>");
			}
