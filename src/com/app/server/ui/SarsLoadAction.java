...
public class SarsLoadAction extends Action{
	public ActionForward execute(ActionMapping mapping,ActionForm form,
			...
			CopyOnWriteArrayList<String> sars=(CopyOnWriteArrayList<String>)singham.getAttribute(new ObjectName("com.app.server:type=deployer,service=SARDeployer"), "SarsDeployed");
