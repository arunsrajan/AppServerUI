...
public class SarsLoadAction extends Action{
	public ActionForward execute(ActionMapping mapping,ActionForm form,
			...
			session.setAttribute("filter", ".sar");
			CopyOnWriteArrayList<String> sars=(CopyOnWriteArrayList<String>)singham.getAttribute(new ObjectName("org.singam.server:type=deployer,service=SARDeployer"), "SarsDeployed");
			StringBuffer buffer=new StringBuffer();
			buffer.append("<div id='tablediv'><table id='table' align='center'><thead><tr><th>"
					+ "delete</th><th>sars</th></tr></thead><tfoot>	<tr>		"
					+ "<th>delete</th>		<th>sars</th></tfoot><tbody>");
			for(String sar:sars){
				buffer.append("<tr><td align='center'><img src='delete.gif' class='mousechange' onclick='undeploy(\""+sar+"\")'/></td>");
				buffer.append("<td align='center'>"+sar+"</td></tr>");
			}
