...
public class JarLoadAction extends Action{
	public ActionForward execute(ActionMapping mapping,ActionForm form,
			...
			CopyOnWriteArrayList<String> ears=(CopyOnWriteArrayList<String>)singham.getAttribute(new ObjectName("com.app.server:type=deployer,service=EJBDeployer"), "JarsDeployed");
			StringBuffer buffer=new StringBuffer();
			buffer.append("<div id='tablediv'><table id='table' align='center'><thead><tr><th>"
					+ "delete</th><th>ears</th></tr></thead><tfoot>	<tr>		"
					+ "<th>delete</th>		<th>jars</th></tfoot><tbody>");
			for(String ear:ears){
